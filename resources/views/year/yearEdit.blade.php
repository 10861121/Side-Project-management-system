        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 mb-4">
                    ...
                    @endif
                    <form action="{{action('ExhibitionYearController@YearEditAction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                         <input type="hidden" class="form-control" name="id" aria-describedby="emailHelp" placeholder="title" value="{{$DByear->EXHIBITION_YEAR_ID}}">
                        <div class="form-group">
                            <label>年分</label>
                            <input type="text" class="form-control" name="year" id="title" aria-describedby="emailHelp" placeholder="title" value="{{$DByear->EXHIBITION_YEAR}}">
                        </div>
                        </br>
