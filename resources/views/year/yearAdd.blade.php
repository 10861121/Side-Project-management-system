        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 mb-4">
                    ...
                    @endif
                    <form action="{{action('ExhibitionYearController@YearAddAction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>年分</label>
                            <input type="text" class="form-control" name="year" id="title" aria-describedby="emailHelp" placeholder="title">
                        </div>            
