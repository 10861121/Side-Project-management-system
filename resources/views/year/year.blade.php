            ...
            <div class="row">
                ...
                <div class="col-lg-10 mb-4">
                    <div class="row align-items-center">
                        <div class="col-lg-12 mb-12 mt-2"><h3>年份管理</h5></div>
                    </div>
                    <div class="col-lg-2 mb-4 mt-2" style="display: inline; "><a href="{{action('ExhibitionYearController@YearAdd')}}" class="btn btn-primary">+ 新增</a></div>
                    <div class="col-lg-2 mb-4 mt-2" style="display: inline; "><a href="javascript:history.back()" class="btn btn-danger">上一頁</a></div>
                    <div class="my-2"></div>
                    <table id="table_id" class="display">
                        ...
                        <tbody>
                            @if(isset($DByear))
                                @foreach($DByear as $year)
                                    <tr>
                                        <td>{{$year->EXHIBITION_YEAR}}</td>
                                        <td><a href="{{action('ExhibitionYearController@YearEdit',$year->EXHIBITION_YEAR_ID)}}" class="btn btn-warning">+ 修改</a></td>
                                        <td><a href="{{action('ExhibitionYearController@YearDeleteAction',$year->EXHIBITION_YEAR_ID)}}" class="btn btn-danger">+ 刪除</a></td>
                                    </tr>
                                @endforeach
                            @endif
                        </tbody>
