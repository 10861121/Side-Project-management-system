        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-10 mb-4">
                    ...
                    @endif
                    <form action="{{action('ArtistController@ArtistAddAction')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>名字</label>
                            <input type="text" class="form-control" name="name" id="title" aria-describedby="emailHelp" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label>英文名字</label>
                            <input type="text" class="form-control" name="ename" id="title" aria-describedby="emailHelp" placeholder="title">
                        </div>
                        <div class="form-group">
                            <label>內容介紹</label>
